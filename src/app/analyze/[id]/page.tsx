    ...
    <main className="relative min-h-screen">
      ...
      <div className="relative px-4 py-6 md:px-8 md:py-8">
        <div className="mx-auto max-w-4xl">
          {/* Header */}
          <header className="mb-8 flex items-center justify-between reveal">
            <Link
              href="/"
              className="group flex items-center gap-2 rounded-xl px-3 py-2 text-sm text-muted-foreground transition-all duration-200 hover:bg-surface hover:text-foreground"
            >
            ...
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <span className="font-semibold tracking-tight">Assay</span>
            </Link>
          </header>
          ...
          <div className="space-y-6 reveal reveal-delay-1">
            ...
            {isComplete && <IssueList analysisId={analysisId} />}
          </div>
        </div>
      </div>
    </main>
